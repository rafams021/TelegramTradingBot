"""
Model Trainer - Fase 2

Entrena modelo LightGBM con datos históricos de trading.
"""
...
def train_model(
    ...
    Args:
        ...
        n_estimators: Árboles en el modelo
    ...
    # Split train/test (sin shuffle para mantener orden temporal)
...
if __name__ == "__main__":
    print("Model Trainer - Fase 2")
    print("Uso: Importa train_model() y pásale X, y")